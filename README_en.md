...
A simple tool to convert screenshots, mockups and Figma designs into clean, functional code using AI. This is a free version using Gemini 2.5 related models. **If you need more advanced models, please obtain the API key first and then adjust the code to enable it**. ~~Now supporting Gemini 3 and Claude Opus 4.5!~~

Original project please refer to the source: https://github.com/abi/screenshot-to-code

https://github.com/user-attachments/assets/85b911c0-efea-4957-badb-daa97ec402ad

Supported stacks:(Ultimately still generates html files)
...
- Gemini 2.5 Flash and Pro and Lite
- ~~Gemini 3 Flash and Pro - Best models! (Google)Temporarily disabled due to lack of API key~~
...
Open http://localhost:1234 to use the app.
...
The app will be up and running at http://localhost:1234. Note that you can't develop the application with this setup as the file changes won't trigger a rebuild.
